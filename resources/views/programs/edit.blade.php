                        ...
                        <div class="space-y-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="relative">
                                    ...
                                    <input id="name" type="text" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:border-gray-500 block w-full ps-10 p-2.5" placeholder="Enter name" autocomplete="off" value="{!! $program->name !!}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="relative">
                                    ...
                                    <input id="session" type="text" name="session" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:border-gray-500 block w-full ps-10 p-2.5" placeholder="Enter session" autocomplete="off" value="{!! $program->session !!}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="relative">
                                    ...
                                    <input id="time" type="text" name="time" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:border-gray-500 block w-full ps-10 p-2.5" placeholder="Enter time" autocomplete="off" value="{!! $program->time !!}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="relative">
                                    ...
                                    <input id="startdate" type="text" name="startdate" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:border-gray-500 block w-full ps-10 p-2.5" placeholder="Enter start date" autocomplete="off" value="{!! $program->startdate !!}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="relative">
                                    ...
                                    <input id="location" type="text" name="location" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:border-gray-500 block w-full ps-10 p-2.5" placeholder="Enter location" autocomplete="off" value="{!! $program->location !!}">
                                </div>
                            ...
                            <div class="w-[500px]">
                                <div class="border-2 border-gray-300 border-dashed rounded-xl p-6 relative">
                                    ...
                                    <div class="text-center">
                                        <img id="preview-1" src="{{ asset($program->image) }}" class="w-52 h-52 object-cover mx-auto" />
                            ...
                            <div class="flex justify-end gap-3">
                                ...
                                <button type="submit" class="px-4 py-3 bg-gray-500 text-gray-50 rounded-lg">Update</button>
                            </div>
                        </div>
                    </form>
                </div>
